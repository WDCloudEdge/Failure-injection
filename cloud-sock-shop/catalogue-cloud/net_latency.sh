...
do
    ...
    if [ $is_scale ]; then
        ...
        kubectl scale deployment catalogue-cloud --replicas=$(( $(kubectl get deployment catalogue-cloud -n cloud-sock-shop -o=jsonpath='{.spec.replicas}') + 1)) -n cloud-sock-shop
    fi
	sleep 120
